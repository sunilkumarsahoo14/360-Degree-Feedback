...
<div class="container mt-2">
    ...
    <form action="functions.php" method="POST" class="bg-white p-4 rounded shadow-sm">
        ...
        <button type="submit" name="add_student" class="btn btn-success">Add Faculty</button>
    </form>
</div>
</body>
</html>
